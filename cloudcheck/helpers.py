...
def defrag_cidrs(cidrs: List[Union[ipaddress.IPv4Network, ipaddress.IPv6Network]]) -> List[Union[ipaddress.IPv4Network, ipaddress.IPv6Network]]:
    """
...
def _can_merge_networks(net1: Union[ipaddress.IPv4Network, ipaddress.IPv6Network], 
...
def _are_adjacent_networks(net1: Union[ipaddress.IPv4Network, ipaddress.IPv6Network], 
                          net2: Union[ipaddress.IPv4Network, ipaddress.IPv6Network]) -> bool:
    """
...
def _merge_networks(net1: Union[ipaddress.IPv4Network, ipaddress.IPv6Network], 
                   net2: Union[ipaddress.IPv4Network, ipaddress.IPv6Network]) -> Union[ipaddress.IPv4Network, ipaddress.IPv6Network]:
    """
...
def strings_to_cidrs(cidr_strings: List[str]) -> List[Union[ipaddress.IPv4Network, ipaddress.IPv6Network]]:
    """
